    ...
    render() {
        ...
        return (
            <div className="login-container">
                <h1 className="page-signin">Đăng Nhập</h1>
        ...
        return (
            <Form onSubmit={this.handleSubmit} className="login-form">
                ...
                <FormItem>
                    ...
                    <Button type="primary" htmlType="button" size="large" className="login-form-button">
                        <Link to="/resetpass">Đặt lại mật khẩu</Link>
                    </Button>
