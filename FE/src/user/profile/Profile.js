                    ...
                    >
                        ...
                        <FormItem>
                            <Button type="primary"
                                ...
                                size="large"
                                className="btn-register-doctor signup-form-button"
                                disabled={this.isFormInvalidProfile()}>Cập Nhật</Button>
                        </FormItem>
                    ...
                    <div className="clinic-left-profile">
                        ...
                        <div className="infor-profile">
                            <div className="detail-profile">
                                ...
                                <div className="icon-infor-profile">{dataprofile && dataprofile.birthday ? moment(dataprofile.birthday).format(dateFormat) : ""}</div>
                            </div>
                            ...
                            <div className="detail-profile">
                                ...
                                <div className="icon-infor-profile">{dataprofile ? dataprofile.mobile : ""}</div>
                            </div>
                            <br />
                            <div className="detail-profile">
                                <div className="icon-profile">
